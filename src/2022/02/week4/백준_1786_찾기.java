...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		List<Integer> foundPositions = StringSearchKMP(text, pattern);

		sb.append(foundPositions.size()).append("\n");
		for (int index : foundPositions) {
	...
	public static List<Integer> StringSearchKMP(String text, String pattern) {
